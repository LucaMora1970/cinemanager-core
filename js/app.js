        ...
        for(let j=i+1;j<filmShows.length;j++){
          ...
          if(fasciaA===fasciaB){
            ...
            issues.push({
              ...
              msg:'<strong>'+(film?film.title:(s.oaFilmTitle||s.name||'?'))+'</strong> programmato in fascia <strong>'+fasciaA+'</strong> sia in <span style="color:'+slA.col+'">'+slA.n+'</span> ('+a.start+') che in <span style="color:'+slB.col+'">'+slB.n+'</span> ('+b.start+')'
            });
          }
        }
      }
